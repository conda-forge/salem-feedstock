...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/salem-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11287&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/salem-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `salem` can be installed with:

```
conda install salem
```

It is possible to list all of the versions of `salem` available on your platform with:
